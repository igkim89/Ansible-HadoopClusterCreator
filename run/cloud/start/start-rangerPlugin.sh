...
then
  ~/.pyenv/shims/ansible-playbook -vv -i /home/bigdata/ansible/environments/cloud/hosts.yml /home/bigdata/ansible/playbooks/start/start-rangerPlugin.yml --extra-vars "variable_host=all"
else
