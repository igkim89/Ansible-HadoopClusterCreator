...
echo -n -e "${RED_COLOR}Do you want to restart the Prometheus service now?${NO_COLOR}"
echo -n -e "${RED_COLOR}Alternatively, you can use the reload function to apply the changed settings.${NO_COLOR}"
echo -n -e "${RED_COLOR}To use the 'reload' function without restarting, enter 'r' or 'R'${NO_COLOR}"
echo -n -e "(y/n/r)"
read restart
...
then
  ...
  echo "Prometheus configuration reload was successful."
else
