...
echo -n -e "${YELLOW_COLOR}You can use the reload function to apply the changed settings.${NO_COLOR} \n"
echo -n -e "${YELLOW_COLOR}To use the 'reload' function without restarting, enter 'r' or 'R'${NO_COLOR} \n"
...
then
  ...
  echo -n -e "${GREEN_COLOR}Prometheus configuration reload was successful.${NO_COLOR}"
else
