...
if [ $# -eq 0 ]; then
  ...
  ~/.pyenv/shims/ansible-playbook -vv -i /home/bigdata/ansible/environments/prod/hosts.yml /home/bigdata/ansible/playbooks/stop/stop-mariadb.yml --extra-vars "variable_host=$1"
fi